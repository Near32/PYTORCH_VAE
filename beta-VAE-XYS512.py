...
from models512 import Rescale, betaVAE, betaVAEdSprite, betaVAEXYS, Bernoulli
...
def setting(nbr_epoch=100,offset=0,train=True,batch_size=32):	
	...
	global use_cuda
	beta = 5000e0
	betavae = betaVAEXYS(beta=beta,z_dim=z_dim,img_dim=img_dim,img_depth=img_depth, use_cuda=use_cuda)
	print(betavae)
	...
	path = 'test--XYS512--img{}-lr{}-beta{}-z{}'.format(img_dim,lr,beta,z_dim)
